...
?>
<svg class="laptopia-cta-icon" width="17" height="17" viewBox="0 0 24 24" fill="<?php echo $filled ? 'currentColor' : 'none'; ?>" stroke="<?php echo $filled ? 'none' : 'currentColor'; ?>" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
