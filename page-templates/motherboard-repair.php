...
<header class="laptopia-header" dir="rtl">
  <div class="laptopia-header-inner">
    ...
    <nav class="laptopia-nav" aria-label="ניווט ראשי">
      ...
      <a href="#board">תיקון ברמת הרכיב</a>
...
<main dir="rtl">
  ...
  <section class="laptopia-section laptopia-hero" aria-labelledby="repair-title">
    <div class="laptopia-hero-content">
      ...
      <div class="laptopia-buttons">
        <a class="laptopia-btn laptopia-btn-whatsapp" href="https://wa.me/972538036244" target="_blank" rel="noopener">לתיאום אבחון בוואטסאפ</a>
  ...
  <section class="laptopia-section laptopia-board" id="board" aria-labelledby="board-title">
    <div class="laptopia-board-content">
      ...
      <p>תיקון לוחות אם הוא אחד מתחומי ההתמחות המרכזיים של Laptopia. התהליך מתחיל באבחון מקור התקלה ובבדיקת אפשרות התיקון.</p>
